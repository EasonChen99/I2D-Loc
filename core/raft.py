...
from extractor import BasicEncoder, BasicEncoder_LIDAR
...
class RAFT(nn.Module):
    ...
    def forward(self, image1, image2, iters=12, lidar_mask=None, flow_init=None, upsample=True, test_mode=False):
        ...
        with autocast(enabled=self.args.mixed_precision):
            ...
            fmap1 = self.fnet_lidar(image1, lidar_mask)
        ...
        with autocast(enabled=self.args.mixed_precision):
            cnet = self.cnet(image1, lidar_mask)
